...
public class Expriment5E {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < size; i++){
            System.out.println("Enter a Student details: id, name, math, physics, chemistry ");
            students[i] = new Student(sc.nextInt(), sc.nextLine(), sc.nextInt() , sc.nextInt(), sc.nextInt());
            //pending
        }
